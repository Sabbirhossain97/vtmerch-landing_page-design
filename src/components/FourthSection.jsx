...
function FourthSection() {
    return (
        <div className='relative third-section min-h-[577px]'>
            <div className='absolute top-[54px] left-[90px]'>
            ...
            <div className='pl-[150px] pt-[204px]'>
                <p className='text-[#fff] font-montserrat text-[48px] not-italic font-bold leading-[57px] tracking-[0.24px] uppercase'>
            ...
            <div className='absolute bottom-0 right-[78px]'>
