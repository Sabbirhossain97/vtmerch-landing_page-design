        ...
        <div className='py-[100px] px-[50px] lg:px-[100px] xl:px-[120px]'>
            <div className='flex flex-col 2xl:flex-row justify-center '>
                <div className='w-full 2xl:w-1/3 flex flex-col justify-end'>
                    <p data-aos="fade-left" className='font-actOfRejection text-[40px] sm:text-[48px] lg:text-[100px] text-[#272312] not-italic font-normal leading-[64px] lg:leading-[100px] 2xl:leading-[120px] tracking-[0.5px] uppercase text-center 2xl:text-left'>Future Looks Bright</p>
                    <div data-aos="fade-up" className='hidden sm:flex flex-row 2xl:flex-col 2xl:items-start justify-center items-center lg:py-6'>
