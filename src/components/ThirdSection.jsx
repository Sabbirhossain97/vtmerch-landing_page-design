        ...
        <div>
            <div className='bg-[#111] min-h-[852px] flex flex-wrap'>
                ...
                <div className='hidden w-full xl:w-1/2 xl:inline-flex gap-6 items-center '>
                    <img className="xl:w-[354px] 2xl:w-[454px] xl:h-[480px] 2xl:h-[580px]" src='/images/book_1.png' />
                    <img className="xl:w-[304px] 2xl:w-[404px] xl:h-[418px] 2xl:h-[518px]" src='/images/book_2.png' />
                </div>
            </div>
        </div>
    )
