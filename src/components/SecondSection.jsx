    ...
    return (
        ...
        <div className='bg-[#F6F5F5]'>
            ...
            <div className='flex flex-col'>
                <div data-aos="fade-up" className='font-montserrat text-[32px] lg:text-[50px] xl:text-[60px] 2xl:text-[70px] text-center 2xl:text-start not-italic font-semibold leading-[84px] tracking-[0.5px] uppercase w-full px-[50px] lg:px-[150px] mt-[100px]'>
